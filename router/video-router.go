...
func SetVideoRouter(router *gin.Engine) {
	...
	videoV1Router.Use(middleware.MultipartFileToURL())
	{
	...
	{
		videoV1Router.POST("/videos", middleware.GlobalAPIVideoRateLimit(), middleware.TaskConcurrencyLimit(), controller.RelayTask)
